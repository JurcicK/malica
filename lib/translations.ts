export type Language = 'sl' | 'en' | 'uk' | 'bs'
...
export const translations: Record<Language, TranslationTree> = {
  sl: {
    appName: 'Malica App',
    heroTitle: 'Naročanje malice za Jurčič Transport',
    heroBody: 'Naroči svojo malico najkasneje do 10. ure za isti dan.',
    ...
    languageLabel: 'Jezik',
    languages: { sl: 'Slovenščina', en: 'English', uk: 'Українська', bs: 'Bosanski' },
    loginTitle: 'Prijava',
    loginSubtitle: 'Prijavi se za pregled ponudbe in oddajo naročila.',
    ...
    addMealHint: 'Tukaj simulirava tvoj tedenski proces iz Excela. Ko admin vnese jed, app sam pripravi angleški, ukrajinski in bosanski prikaz.',
    category: 'Kategorija',
    categoryLabels: {
      'bodi fit': 'Bodi fit',
      vege: 'Vege',
  ...
  en: {
    appName: 'Lunch App',
    heroTitle: 'Meal ordering for Jurcic Transport',
    heroBody: 'Order your meal by 10:00 for the same day.',
    ...
    languages: { sl: 'Slovenian', en: 'English', uk: 'Ukrainian', bs: 'Bosnian' },
    loginTitle: 'Login',
    loginSubtitle: 'Sign in to view the menu and place your order.',
    username: 'Username',
    password: 'Password',
    loginButton: 'Log in',
    ...
    addMealHint: 'This simulates your weekly Excel process. When the admin enters a meal, the app automatically prepares English, Ukrainian and Bosnian text.',
    category: 'Category',
    categoryLabels: {
      'bodi fit': 'Fit choice',
      vege: 'Veggie',
  ...
  uk: {
    ...
    heroTitle: 'Замовлення обідів для Jurcic Transport',
    heroBody: 'Замовте свій обід до 10:00 на поточний день.',
    ...
    languageLabel: 'Мова',
    languages: { sl: 'Словенська', en: 'Англійська', uk: 'Українська', bs: 'Боснійська' },
    loginTitle: 'Вхід',
    loginSubtitle: 'Увійдіть, щоб переглянути меню та оформити замовлення.',
    ...
    addMealHint: 'Це імітує твій щотижневий процес з Excel. Коли адміністратор вводить страву, застосунок автоматично готує англійський, український та боснійський текст.',
    category: 'Категорія',
    categoryLabels: {
      'bodi fit': 'Фіт-меню',
      vege: 'Вегетаріанське',
    ...
    orderingClosed: 'Замовлення на цей день закрите.',
    ...
    chooseMealTitle: 'Підтвердіть вибір',
    chooseMealText: 'Ви справді хочете обрати цю страву?',
    cancel: 'Скасувати',
    confirm: 'Підтвердити',
    chooseMealButton: 'Обрати страву',
  },
  bs: {
    appName: 'Aplikacija za gablec',
    heroTitle: 'Narucivanje obroka za Jurcic Transport',
    heroBody: 'Naruci svoj obrok najkasnije do 10:00 za isti dan.',
    heroMetricEmployees: 'demo zaposlenih u testnom prikazu',
    heroMetricDays: 'dana u sedmicnoj ponudi',
    heroMetricOpenDays: 'dana je trenutno jos otvoreno',
    demoAccess: 'Demo pristup',
    demoAdmin: 'Admin',
    demoEmployee: 'Zaposleni',
    languageLabel: 'Jezik',
    languages: { sl: 'Slovenski', en: 'English', uk: 'Ukrajinski', bs: 'Bosanski' },
    loginTitle: 'Prijava',
    loginSubtitle: 'Prijavi se za pregled ponude i slanje narudzbe.',
    username: 'Korisnicko ime',
    password: 'Lozinka',
    loginButton: 'Prijava u aplikaciju',
    badLogin: 'Pogresno korisnicko ime ili lozinka.',
    logout: 'Odjava',
    loading: 'Ucitavanje aplikacije...',
    weekSourceIntro: 'Izvor ponude',
    welcome: 'Dobrodosao',
    employeeIntro: 'Izaberi dan i sacuvaj svoj obrok prije dnevnog zakljucavanja u 10:00.',
    adminIntro: 'Ovdje vidis prijave po danima i mozes rucno dodavati jela iz sedmicne ponude.',
    days: 'Dani',
    availableMeals: 'jela na raspolaganju',
    registrationsForDay: 'prijava za taj dan',
    locked: 'Zakljucano',
    open: 'Otvoreno',
    selected: 'Izabrano',
    nothingSelected: 'Jos nije izabrano',
    selectedForDay: 'Izabrano:',
    remove: 'Ukloni',
    adminOverview: 'Admin pregled',
    whoOrdered: 'Ko je narucio',
    noOrders: 'Za izabrani dan jos nema prijava.',
    manualEntry: 'Rucni unos',
    addMeal: 'Dodaj novo jelo',
    addMealHint: 'Ovdje simuliramo tvoj sedmicni proces iz Excela. Kada admin unese jelo, aplikacija sama pripremi engleski, ukrajinski i bosanski prikaz.',
    category: 'Kategorija',
    categoryLabels: {
      'bodi fit': 'Fit izbor',
      vege: 'Vege',
      'ali pa..': 'Ili..',
      'na hitro...': 'Na brzinu...',
      'stalna ponudba': 'Stalna ponuda',
    },
    day: 'Dan',
    mealTitle: 'Naziv jela',
    description: 'Opis',
    allergens: 'Alergeni',
    optional: 'Opcionalno',
    addToOffer: 'Dodaj u ponudu',
    addingMeal: 'Dodajem u ponudu...',
    edit: 'Uredi',
    saveDraft: 'Sacuvaj skicu',
    mealPlaceholder: 'Unesi obrok...',
    cutoffAt: 'Zakljucavanje u',
    orderingClosed: 'Narucivanje za taj dan je zatvoreno.',
    orderingOpen: 'Narucivanje za taj dan je jos otvoreno.',
    orderSaved: 'Obrok za {day} je sacuvan.',
    dayLockedMessage: '{day} je nakon {hour}:00 vec zakljucan.',
    enterMealTitle: 'Unesi naziv jela.',
    mealAdded: 'Novo jelo je dodano u ponudu.',
    mealAddedFallback: 'Novo jelo je dodano u ponudu. Koristen je lokalni rezervni prevod.',
    translationUnavailable: 'Automatski prevod trenutno nije dostupan.',
    chooseMealTitle: 'Potvrdi izbor',
    chooseMealText: 'Da li stvarno zelis izabrati ovaj obrok?',
    cancel: 'Odustani',
    confirm: 'Potvrdi',
    chooseMealButton: 'Izaberi obrok',
  },
}
